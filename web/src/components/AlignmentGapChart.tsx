...
export function AlignmentGapChart() {
  ...
  return (
    <div className="cd-card" style={{ padding: 24, position: "relative" }}>
      ...
      >
        <div>
          <div className="meta">Fig. 1 · The alignment gap against capacity to close it</div>
          <p style={{ margin: "6px 0 0", fontSize: 13, color: "var(--ink-2)", maxWidth: 640, lineHeight: 1.5 }}>
            Vertical axis: dollars per year of net price. Dots above the brick line have
            a heavier graduate debt burden than this corpus&apos;s median. Horizontal axis:
            endowment per undergraduate, log scale. Color: instructional spending as a
            share of net price. Hover any dot — every school is named.
          </p>
        </div>
