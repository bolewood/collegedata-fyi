...
- [**Alignment gap**](./alignment-gap.md) — scatter of the net-price change that would put a school's graduates at the corpus median debt burden against endowment per undergraduate. Joins CDS SAT midpoints to Scorecard earnings, debt, net price, and IPEDS endowment / instructional spend. Hover names every school.
