...
- **[RESOLVED 2026-04-17] ~~Cross-year schema diff tool~~** Shipped as `tools/schema_builder/diff.py` with 5 year-pair diffs committed to `schemas/`:
  ...
  **Follow-ups:** resolved for the C1/C9 slice in PRD 020 prep: 2024-25 now has a structural schema from the local template, and 2019-20 through 2023-24 have conservative C1/C9 canonical overlays. Broader section overlays remain future work when a product slice needs them.
