...
| Frontend | ✅ Live at `collegedata.fyi` (Vercel). Includes landing with search, match list builder, queryable browser, school directory, school detail, year detail with field viewer, about, recipes, API docs, public-reviewed school-page change cards, and an operator-only `/changes` digest. Consumes PostgREST plus `browser-search`. See [`docs/prd/002-frontend.md`](prd/002-frontend.md), [`docs/prd/010-queryable-data-browser.md`](prd/010-queryable-data-browser.md), [`docs/prd/017-match-list-builder.md`](prd/017-match-list-builder.md), and [`docs/prd/019-cds-change-intelligence.md`](prd/019-cds-change-intelligence.md). |
