...
| Merit profile data asset (PRD 018) | Product slice in progress. H2A Tier 4 cleanup and targeted redrain shipped 2026-05-03; `school_merit_profile` exposes latest primary CDS Section H merit/need-aid facts plus Scorecard affordability/outcomes for the school-page card and public API docs. |
