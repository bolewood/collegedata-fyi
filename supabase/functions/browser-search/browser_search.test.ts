...
function row(overrides: Partial<BrowserRow>): BrowserRow {
  return {
    ...
    ed_applicants: null,
    ed_admitted: null,
    ed_has_second_deadline: null,
    ea_offered: null,
    ea_restrictive: null,
    wait_list_policy: null,
    wait_list_offered: null,
    wait_list_accepted: null,
    wait_list_admitted: null,
    c711_first_gen_factor: null,
    c712_legacy_factor: null,
    c713_geography_factor: null,
    c714_state_residency_factor: null,
    c718_demonstrated_interest_factor: null,
    app_fee_amount: null,
